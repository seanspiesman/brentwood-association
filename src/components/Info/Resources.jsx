  ...
  return (
    <div className="container elements">
      <div className="row">
        ...
        <div className="col col-md-6">
          <h3>City of Austin Resources</h3>
          <ul>
            <li>
              <a href="http://www.austintexas.gov/">City of Austin Website</a>
            </li>
            <li>
              <a href="http://www.austintexas.gov/department/city-manager">
                Austin City Manager
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="http://austinrev.org/">
                Aiston Revotalization Authority
              </a>
            </li>
            <li>
              <a href="http://www.main.org/canpacaustin/index.htm">
                Central Austin Neighborhood Plan Advisory Committee
              </a>
            </li>
            <li>
              <a href="https://www.austintexas.gov/department/imagine-austin">
                Imagine Austin News
              </a>
            </li>
          </ul>
